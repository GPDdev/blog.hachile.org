...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "Gunpowder 的个人博客",

	// 站点 URL
	site_url: "https://blog.hachile.org",

	// 站点描述
	description: "Gunpowder 的个人博客，记录学习、开发与生活。",

	// 站点关键词
	keywords: ["Hachile", "Gunpowder", "个人博客", "开发", "生活"],
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/hachile-avatar.png",
			alt: "Gunpowder",
		},
		// 导航栏标题
		title: "Hachile Blog",
